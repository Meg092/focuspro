...
class FtListenRepeatView extends GetView<FtListenRepeatLogic> {
  const FtListenRepeatView({super.key});
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text('Listen & Repeat: ${controller.digitCount} Digits'),
  ...
  Widget _buildInstructionsCard() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            '🎯 Target: Training focus concentration and short-term memory.',
            style: TextStyle(fontSize: 14.sp, color: Colors.white),
          ),
          SizedBox(height: 6.h),
          Text(
            '📋 Method: After hearing ${controller.digitCount} digits, start repeating and input the result.',
            style: TextStyle(fontSize: 14.sp, color: Colors.white),
          ),
        ],
      ),
  ...
  Widget _buildTipsAndControls() {
    return Padding(
      ...
      child: Column(
        children: [
          Text(
            '💡 Tip: Kids can just repeat, parents can help record or input results',
