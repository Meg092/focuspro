...
class FtListenReverseLogic extends GetxController {
  ...
  Future<void> onPlayTap() async {
    ...
    try {
      final random = Random();
      currentDigits.value = List.generate(3, (_) => random.nextInt(10));
      userInput.clear();
  ...
  Future<void> _checkAnswer() async {
    ...
    final correctAnswer = currentDigits.reversed.toList();
    final isCorrect = _compareAnswers(correctAnswer, userInput);
  ...
  void _showResultDialog({
    ...
    final percentile = calculatePercentile(score, 'listen_reverse');
