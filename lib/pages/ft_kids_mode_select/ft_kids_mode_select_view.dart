...
class FtKidsModeSelectView extends GetView<FtKidsModeSelectLogic> {
  const FtKidsModeSelectView({super.key});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(
                  'Click numbers from small to large in order. After correct click, numbers turn dark',
                  style: TextStyle(
                    fontSize: 14.sp,
  ...
  Widget _buildLevelGrid() {
    final levels = ['3×3', '4×4', '5×5', '6×6', '7×7', '8×8', '9×9', 'A-Z', 'a-z'];
