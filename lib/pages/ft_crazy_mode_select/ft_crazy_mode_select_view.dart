...
class FtCrazyModeSelectView extends GetView<FtCrazyModeSelectLogic> {
  const FtCrazyModeSelectView({super.key});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                Text(
                  'After each correct click, all remaining numbers reshuffle randomly!',
                  style: TextStyle(
                    fontSize: 14.sp,
